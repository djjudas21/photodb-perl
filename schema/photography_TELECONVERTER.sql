...
CREATE TABLE `TELECONVERTER` (
  ...
  `model` varchar(45) DEFAULT NULL COMMENT 'Model name of this teleconverter',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table to catalog teleconverters (multipliers)';
