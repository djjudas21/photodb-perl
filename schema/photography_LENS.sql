...
CREATE TABLE `LENS` (
  ...
  `url` varchar(145) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serial` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_code` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `coating` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hood` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exif_lenstype` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `formula` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shutter_model` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`lens_id`),
