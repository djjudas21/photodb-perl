...
CREATE TABLE `FILM` (
  ...
  `notes` varchar(145) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `development_notes` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `film_batch` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `processed_by` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
