...
CREATE TABLE `CAMERA` (
  ...
  `metering_pattern_id` int(11) DEFAULT NULL COMMENT 'Denotes the meter''s sensitivity pattern',
  ...
  `M` tinyint(1) DEFAULT NULL COMMENT 'Whether the camera supports full manual exposure',
  `Av` tinyint(1) DEFAULT NULL COMMENT 'Whether the camera supports aperture-priority exposure',
  `Tv` tinyint(1) DEFAULT NULL COMMENT 'Whether the camera supports shutter-priority exposure',
  `P` tinyint(1) DEFAULT NULL COMMENT 'Whether the camera supports program/auto exposure',
  `min_shutter` varchar(6) DEFAULT NULL COMMENT 'Fastest available shutter speed, expressed like 1/400',
  `max_shutter` varchar(6) DEFAULT NULL COMMENT 'Slowest available shutter speed, expressed like 30"',
  ...
  CONSTRAINT `fk_metering_pattern` FOREIGN KEY (`metering_pattern_id`) REFERENCES `METERING_PATTERN` (`metering_pattern_id`) ON DELETE CASCADE ON UPDATE CASCADE,
