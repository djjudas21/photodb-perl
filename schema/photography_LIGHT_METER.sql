...
CREATE TABLE `LIGHT_METER` (
  ...
  `model` varchar(45) DEFAULT NULL COMMENT 'Model name or number of the light meter',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table to catalog light meters';
