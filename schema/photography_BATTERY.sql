...
CREATE TABLE `BATTERY` (
  ...
  `other_names` varchar(45) DEFAULT NULL COMMENT 'Alternative names for this kind of battery',
  PRIMARY KEY (`battery_type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table to catalog of types of battery';
