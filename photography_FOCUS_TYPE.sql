...
CREATE TABLE `FOCUS_TYPE` (
  ...
  `focus_type` varchar(45) DEFAULT NULL,
...
LOCK TABLES `FOCUS_TYPE` WRITE;
/*!40000 ALTER TABLE `FOCUS_TYPE` DISABLE KEYS */;
INSERT INTO `FOCUS_TYPE` VALUES (1,'Auto'),(2,'Fixed'),(3,'Guess'),(4,'Rangefinder'),(5,'SLR'),(6,'TLR'),(7,'View');
/*!40000 ALTER TABLE `FOCUS_TYPE` ENABLE KEYS */;
UNLOCK TABLES;
