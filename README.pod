...
This text-mode version of PhotoDB has been deprecated and replaced with a web-based version.
This version is still available but the development has ceased.
