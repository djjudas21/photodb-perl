...
/*!40000 ALTER TABLE `ARCHIVE_TYPE` DISABLE KEYS */;
INSERT INTO `ARCHIVE_TYPE` VALUES (1,'Film'),(2,'Slide'),(3,'Print');
/*!40000 ALTER TABLE `ARCHIVE_TYPE` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `METERING_TYPE` DISABLE KEYS */;
INSERT INTO `METERING_TYPE` VALUES (1,'Cadmium sulphide'),(2,'Selenium'),(7,'Silicon');
/*!40000 ALTER TABLE `METERING_TYPE` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `METERING_MODE` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `NEGATIVE_SIZE` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `NEGATIVE_SIZE` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `SHUTTER_SPEED` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `SHUTTER_SPEED` ENABLE KEYS */;
UNLOCK TABLES;
