...
CREATE TABLE `PRINT` (
  ...
  `bleach_time` time DEFAULT NULL,
  `toner_id` int(11) DEFAULT NULL COMMENT 'ID of the toner used to make this print',
  `toner_dilution` varchar(6) DEFAULT NULL COMMENT 'Dilution of the toner used to make this print',
  `toner_time` time DEFAULT NULL COMMENT 'Duration of toning',
  `2nd_toner_id` int(11) DEFAULT NULL,
  `2nd_toner_dilution` varchar(6) DEFAULT NULL,
  `2nd_toner_time` time DEFAULT NULL,
  ...
  `sold_price` decimal(5,2) DEFAULT NULL,
